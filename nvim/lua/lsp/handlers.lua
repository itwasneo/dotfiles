...
local function lsp_keymaps(bufnr)
    ...
    vim.api.nvim_buf_set_keymap(bufnr, "n", "<C-k>", '<cmd> lua vim.diagnostic.goto_prev({float = false})<CR>',
        opts)
    vim.api.nvim_buf_set_keymap(bufnr, "n", "<C-j>", '<cmd> lua vim.diagnostic.goto_next({float = false})<CR>',
        opts)
